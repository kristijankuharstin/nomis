...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                <div id="main-content" style="background-color: white;">
                    ...
                    <div id="main-content-body">
                        <div class="liturgical-units">
                            <xsl:apply-templates select="tei:teiHeader/tei:encodingDesc/tei:classDecl/tei:taxonomy/tei:taxonomy[@n = 'liturgical units']/tei:category">
    ...
    <xsl:template match="tei:category[parent::tei:taxonomy[@n = 'liturgical units']][exists(@n)]">
        <xsl:element name="div">
            <xsl:element name="p">
                <xsl:attribute name="class" select="'heading-liturgical-units'"/>
            ...
            <xsl:element name="p">
                <xsl:attribute name="class" select="'content-liturgical-units'"/>
                <xsl:apply-templates select="root()//tei:div[@type = 'liturgical-unit'] | root()//tei:seg[@type = 'liturgical-unit']" mode="content-liturgical-units">
                    <xsl:with-param name="liturgical-units-category" select="@xml:id"/>
                </xsl:apply-templates>
            </xsl:element>
        </xsl:element>
    </xsl:template>
    
    <xsl:template match="tei:div[@type = 'liturgical-unit']" mode="content-liturgical-units">
        <xsl:param name="liturgical-units-category"/>
        <xsl:if test="contains(@ana,$liturgical-units-category)">
    ...
    <xsl:template match="tei:seg[@type = 'liturgical-unit']" mode="content-liturgical-units">
        <xsl:param name="liturgical-units-category"/>
        <xsl:if test="contains(@ana,$liturgical-units-category)">
            <xsl:element name="span">
                <xsl:attribute name="class" select="'around-links-to-liturgical-units'"/>
    ...
    <xsl:template match="tei:teiHeader">
        ...
        <xsl:element name="p">
            <xsl:attribute name="class" select="'title'"/>
            <xsl:text>Taxonomy: Liturgical Units</xsl:text>
        </xsl:element>
